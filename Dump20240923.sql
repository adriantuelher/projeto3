...
INSERT INTO `blocos` VALUES (2,'Bloco 1',2);
...
INSERT INTO `equipamentos` VALUES (1,'Computador','Material para pesquisa',10);
...
INSERT INTO `espacos` VALUES (9,'Sala 3',NULL),(10,'Sala 2',NULL),(13,'Cantinho da Karine',2);
...
CREATE TABLE `eventos` (
  ...
  `id_tipo_de_evento` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_espaco` (`id_espaco`),
  KEY `fk_espaco_idx` (`id_usuario`),
  KEY `fk_tipo_de_evento_id` (`id_tipo_de_evento`),
  CONSTRAINT `fk_espaco` FOREIGN KEY (`id_espaco`) REFERENCES `espacos` (`id`),
  CONSTRAINT `fk_tipo_de_evento_id` FOREIGN KEY (`id_tipo_de_evento`) REFERENCES `tipos_de_evento` (`id`)
...
INSERT INTO `eventos` VALUES (3,'Aula 1','sala','2025-02-22','11:10:00','12:00:00',0,10,1,NULL),(7,'SeAgro','Apresenta̤̣o','2025-03-01','10:30:00','12:00:00',0,10,2,NULL);
...
--
-- Table structure for table `tipos_de_evento`
--

DROP TABLE IF EXISTS `tipos_de_evento`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tipos_de_evento` (
  `id` int NOT NULL AUTO_INCREMENT,
  `descricao` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `tipos_de_evento`
--

LOCK TABLES `tipos_de_evento` WRITE;
/*!40000 ALTER TABLE `tipos_de_evento` DISABLE KEYS */;
/*!40000 ALTER TABLE `tipos_de_evento` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `unidades` VALUES (2,'Campus Manhuacu'),(4,'Campus Juiz de Fora');
...
INSERT INTO `usuarios` VALUES (2,'admin','123','admin@','Admin','admin',1),(6,'andremtherion','ceus','andreklacerda@proton.me','Andre','Aluno',4);
...
INSERT INTO `vegetais` VALUES (3,'Caf̩','Planta',10);
...
-- Dump completed on 2024-09-23 12:51:37
